  ...
  console.log(watch("password"));
    return (
        <div className="auth-wrapper">
            ...
            <form>
                <label>Email</label>
                <input name="email" type="email" {...register({required: true, pattern: /^\S+@\S+$/i})}/>
                {errors.email && <p>This email field is required</p>}
                
                <label>Name</label>
                <input name="name" {...register({required:true, maxLength:10})}/>
                ...
                <input name="password" type="password" {...register({required:true, pattern: /^(?=.*[A-Za-z])(?=.*\d)(?=.*[$@$!%*#?&])[A-Za-z\d$@$!%*#?&]{8,16}$/})}/>
                ...
                <input name="password_confirm" type="password" {...register({required:true, validate:(value)=>value===password.current})}/>
